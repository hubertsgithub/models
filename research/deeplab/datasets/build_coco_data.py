...
tf.app.flags.DEFINE_string(
    'train_image_folder',
    './coco/images_preprocessed/train',
    'Folder containing training images')
tf.app.flags.DEFINE_string(
    'train_image_label_folder',
    './coco/labels_preprocessed/train',
    'Folder containing annotations for training images')

tf.app.flags.DEFINE_string(
    'val_image_folder',
    './coco/images_preprocessed/val',
    'Folder containing val images')
tf.app.flags.DEFINE_string(
    'val_image_label_folder',
    './coco/labels_preprocessed/val',
    'Folder containing annotations for val images')

tf.app.flags.DEFINE_string(
    'test_image_folder',
    './coco/images_preprocessed/test',
    'Folder containing test images')
tf.app.flags.DEFINE_string(
    'test_image_label_folder',
    './coco/labels_preprocessed/test',
    'Folder containing annotations for test images')

tf.app.flags.DEFINE_string(
    'output_dir', './coco/tfrecord',
    'Path to save converted SSTable of Tensorflow example')

_NUM_SHARDS = 4

def _convert_dataset(dataset_split, dataset_dir, dataset_label_dir, num=-1):
  """ Converts the coco dataset into into tfrecord format (SSTable).
...
def main(unused_argv):
  ...
  _convert_dataset('train10kseg', FLAGS.train_image_folder, FLAGS.train_image_label_folder, 3096)
  _convert_dataset('train20kseg', FLAGS.train_image_folder, FLAGS.train_image_label_folder, 6192)
  _convert_dataset('train50kseg', FLAGS.train_image_folder, FLAGS.train_image_label_folder, 15480)
  #_convert_dataset('val', FLAGS.val_image_folder, FLAGS.val_image_label_folder)  # TODO need to preprocess.
